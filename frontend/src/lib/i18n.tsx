...
const dictionary = {
  ru: {
    ...
    inviteImportedMessage: 'Комната подключена. Секрет будет синхронизирован для ваших устройств.',
    ...
    quietlineIntro: 'Войдите или создайте аккаунт. Профиль и комнаты синхронизируются с сервером.',
    refresh: 'Обновить',
    revoke: 'Отозвать',
    ...
    roomReadyMessage: 'Комната создана. Если секрет не задан вручную, он синхронизируется сервером для ваших устройств.',
    roomSecret: 'Секрет комнаты',
    roomSecretDescription: 'Введите секрет только для старой или ручной комнаты.',
    roomSecretOptional: 'Свой секрет комнаты',
  ...
  en: {
    ...
    inviteImportedMessage: 'Room joined. The secret will sync for your devices.',
    ...
    quietlineIntro: 'Login or create an account. Your profile and rooms sync with the server.',
    refresh: 'Refresh',
    revoke: 'Revoke',
    ...
    roomReadyMessage: 'Room created. If no custom secret was set, the server syncs it for your devices.',
    roomSecret: 'Room secret',
    roomSecretDescription: 'Enter a secret only for a legacy or manual room.',
    roomSecretOptional: 'Custom room secret',
